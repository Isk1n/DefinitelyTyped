 ...
 * builder instance
 */
export function suite(name: string, callback: (suite: SuiteBuilder) => void): void;
...
declare interface SuiteBuilder {
    /**
...
declare interface IgnoreSelector {
    /**
 ...
 */
declare type ActionsFindCallback = (actions: Actions, find:(selector: string | string[]) => Found) => void
...
declare interface Actions {
     ...
     */
    click(element: string | Found | (string | Found)[]): Actions,
     ...
     * @memberof Actions
     */
    doubleClick(element: string | Found | (string | Found)[]): Actions,
     ...
     * @memberof Actions
     */
    mouseDown(element: string | Found | (string | Found)[], button?: MouseButton): Actions,
     ...
     * @memberof Actions
     */
    mouseUp(element: string | Found | (string | Found)[], button?: MouseButton): Actions,
     ...
     * @memberof Actions
     */
    mouseMove(element: string | Found | (string | Found)[], offset?: Coords): Actions,

    /**
     * drag `element` to other `dragTo` element.
     *
     * @param {(string | Found | (string | Found)[])} element
     * @param {(string | Found | (string | Found)[])} dragTo
     * @memberof Actions
     */
    dragAndDrop(element: string | Found | (string | Found)[], dragTo: string | Found | (string | Found)[]): Actions,
     ...
     * @memberof Actions
     */
    flick(speed: Coords, swipe: Coords, element: string | Found | (string | Found)[]): Actions,
     ...
     * @memberof Actions
     */
    executeJS(jscript: (window: object) => void): Actions,
  ...
  specified element or currently active element on a page.
   ...
   ```
     ...
     * @memberof Actions
     */
    sendKeys(element: string | Found | (string | Found)[], key: Keys): Actions,
